...
import ListaPostagem from '../listapostagem/ListaPostagem.tsx';
    ...
    return (
        <>
            <TabContext value={value}>
                ...
                <TabPanel value="2">
                    <Typography variant="h5" gutterBottom color="textPrimary" component="h5" align="center" className="titulo">About</Typography>
